---
title: 🕵️ Footprinting and Reconnaissance
description: Find information about a target system or network to identify potential vulnerabilities.
slug: guide/footprinting
head:
  - tag: title
    content: Footprinting and Reconnaissance
---
